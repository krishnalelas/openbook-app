...
import 'package:Buzzing/widgets/theming/smart_text.dart';
export 'package:Buzzing/widgets/theming/smart_text.dart';
...
class OBActionableTextState extends State<OBActionableSmartText> {
  ...
  Widget build(BuildContext context) {
    if (_needsBootstrap) {
      ...
      _urlLauncherService = buzzingProvider.urlLauncherService;
