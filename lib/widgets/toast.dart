...
class _BuzzingToast extends InheritedWidget {
  _BuzzingToast({Key key, Widget child}) : super(key: key, child: child);

  @override
  bool updateShouldNotify(_BuzzingToast old) {
    return true;
  }
}
