...
class UserInvite extends UpdatableModel<UserInvite> {
  ...
  static getShareMessageForInviteWithToken(String token, String apiURL) {
    ...
    const String ANDROID_DOWNLOAD_LINK = 'https://play.google.com/apps/testing/buzzing.social.app';
    String inviteLink = apiURL + 'api/auth/invite?token=$token';

    String message = 'Hey, I\'d like to invite you to Buzzing. First, Download the app on iTunes ($IOS_DOWNLOAD_LINK) or the Play store ($ANDROID_DOWNLOAD_LINK). '
        'Second, paste this personalised invite link in the \'Sign up\' form in the Buzzing App: $inviteLink ';
